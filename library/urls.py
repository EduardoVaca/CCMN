...
urlpatterns = [
	...
	url(r'^administrador/category/update/(?P<pk>[0-9]+)/$', views.category_update, name='category_update'),
	...
	url(r'^administrador/book/delete/(?P<pk>[0-9]+)/$', views.book_delete, name='book_delete'),
